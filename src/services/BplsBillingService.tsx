...
export const getBilling = async ({ refno, qtr = 4, showdetails = true }: { refno: string; qtr?: number; showdetails?: boolean }) => {
...
export const generateCode = async ({ refno, txntype }: { refno: string; txntype: string }) => {
