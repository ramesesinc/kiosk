...
const PaymentPrintTicket: ForwardRefRenderFunction<HTMLDivElement, PaymentPrintTicketProps> = ({ QRCode, appDate, addr, total, tdNo, payerName, seriesno, lguName, logo }, ref: Ref<HTMLDivElement>) => (
  <div ref={ref}>
